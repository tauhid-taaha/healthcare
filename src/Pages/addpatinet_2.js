...
const RegisterPatient = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 5 }}>
      ...
      >
        {/* Flexbox Row: Form Left + Image Right */}
        <div style={{ display: "flex", alignItems: "center", gap: "30px" }}>
          ...
          >
            <CardContent sx={{ p: 4 }}>
              ...
              >
                Please fill in the patient details carefully. These details will
                be stored securely on the blockchain and used for authorized
  ...
  <motion.img
    src="https://img.freepik.com/premium-vector/concept-online-medical-consultation-vector-medical-icon-doctor-with-folder-image-personal_81863-5414.jpg"
    alt="Patient Registration"
    style={{ maxWidth: "100%", height: "auto" }}
    animate={{
      y: [0, -10, 0], // floating up and down
      rotate: [0, 1, -1, 0], // slight tilt effect
    }}
    transition={{
      duration: 4,
      repeat: Infinity,
